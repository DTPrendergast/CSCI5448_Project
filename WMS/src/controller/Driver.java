...
public class Driver
{
	...
	public static void main(String[] args)
	{
		...
		System.out.print("Select Operating Mode (1=Sim Warehouse Operations, 2=Real Operations, "
						+ "3=Sim Inventory Management): ");
		int mode = sc.nextInt();
		...
		if (mode == 1) 
		{
			...
			//sim for incoming orders and arriving pallets
